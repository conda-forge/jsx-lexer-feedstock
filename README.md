...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jsx-lexer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9905&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jsx-lexer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jsx-lexer` can be installed with:

```
conda install jsx-lexer
```

It is possible to list all of the versions of `jsx-lexer` available on your platform with:
